...
func NewGlusterfsProvisioner(client kubernetes.Interface) controller.Provisioner {
	return newGlusterfsProvisionerInternal(client)
}

func newGlusterfsProvisionerInternal(client kubernetes.Interface) *glusterfsProvisioner {
